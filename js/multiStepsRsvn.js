...
const SINGLE_PER_NIGHT = 1300;

const OCEAN_PER_NIGHT = 5000;
const BEACH_PER_NIGHT = 5900;
const TRIPLE_PER_NIGHT = 4500;
...
class ReservationCost {
  ...
  priceByRoomType () {
    ...
    if (this.roomType === 'Ocean View') {
      return OCEAN_PER_NIGHT;
      ;
    }SINGLE_PER_NIGHT
    if (this.roomType === 'Beach Front') {
      return BEACH_PER_NIGHT;
    }
    if (this.roomType === 'Triple') {
      return TRIPLE_PER_NIGHT;
    }
