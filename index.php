...
<head>
  ...
  <script>
function setCook(id) {
    document.cookie = "transcript_id=" + id + "; path=/";
}
</script>
</script>
...
<header>
    ...
    <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
            <a href="#" class="navbar-brand d-flex align-items-center">
                <strong>Miracle Grand Hotel</strong>
            </a>
    ...
    <tr>
        ...
        <td>
            <a href="test2.php" onclick="setCook('<?php echo $v["id"]; ?>')">
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">Welcome To Miracle Grand Hotel</h1>
    ...
    <div class="container">
    <img src="image/banner1.gif" width="1100"   height="300" />
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            <h1 class="display-4">GREAT SERVICE</h1>
            <p class="lead">"ยินดีต้อนรับสู่โรงแรมของเราที่มอบบรรยากาศที่งดงามและน่าตื่นเต้นที่จะทำให้คุณอิจฉาตลอดเวลา โรงแรมของเราภูมิใจในการบริการตัวตนของพนักงานต้อนรับที่พร้อมดูแลความต้องการของคุณตลอด 24 ชั่วโมง พนักงานของเรามุ่งมั่นในการให้บริการที่ยอดเยี่ยมเพื่อให้การเข้าพักของคุณกับเราเป็นที่จดจำไปตลอดชีวิต"</p>
        </div>
    </div>
    ...
    <div class="album py-5 bg-light" >
        <div class="container">
            <div class="row">
                <div class="col-md-4" >
                    <div class="card mb-4 box-shadow" style="height: 600px; width: 348px;">
                        ...
                        <div class="card-body">
                            <p class="card-text">ห้องดีลักซ์ขนาด 24 ตร.ม. ที่อยู่อาศัยอย่างสะดวกสบายและงดงาม เป็นที่พักอันเหนือระดับที่จะช่วยให้คุณสามารถปล่อยจิตวิญญาณและร่างกายได้รับการชาร์จใหม่ ห้องดีลักซ์ทุกห้องตั้งอยู่บนชั้นสูง และมีหน้าต่างยาวเต็มความยาว เพื่อให้คุณได้รับการผ่อนคลายในอุณหภูมิและความชื้นที่เหมาะสม ทั้งนี้ยังมีพื้นที่โล่งของห้องดีลักซ์ที่สร้างสรรค์ อีกด้วย</p>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">฿2500 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow" style="height: 600px; width: 348px;">
                        ...
                        <div class="card-body">
                            <p class="card-text">ห้องเตียงคู่มาตรฐานมีสิ่งอำนวยความสะดวกครบครันสำหรับรองรับผู้เข้าพักสองคน ด้วยเตียงสองเตียงเดียวที่ให้ความสะดวกสบายสูงสุดและมีระบบรักษาความปลอดภัยที่ดีมาก ห้องเตียงคู่แบบแอร์เต็มห้องเป็นตัวเลือกที่เหมาะสมสำหรับความต้องการของคุณ จองห้องพักกับเราและเพลิดเพลินกับการเดินทางของคุณอย่างเต็มที่</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                ...
                                <?php } ?>
                                <small class="text-muted">฿1800 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow" style="height: 600px; width: 348px;">
                        ...
                        <div class="card-body">
                            <p class="card-text">ห้องเดี่ยวขนาดเล็กที่มาพร้อมห้องน้ำในตัวพร้อมอุปกรณ์สุขภาพฟรีอย่างเครื่องเป่าผมและอุปกรณ์สำหรับอาบน้ำหรืออาบน้ำแช่ อุปกรณ์และสิ่งอำนวยความสะดวกอื่น ๆ รวมถึง Wi-Fi ฟรี โทรศัพท์ มินิบาร์ และ TV จอแบนพร้อมช่องรายการและภาพยนตร์ให้เลือกดูได้ในห้องนี้</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                ...
                                <?php } ?>
                                <small class="text-muted">฿1300 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow" style="height: 600px; width: 348px;">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Beach Front Room</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/beach.gif" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                        <div class="card-body">
                            <p class="card-text">เมื่อเดินเข้าไปในห้องพักของโรงแรมนี้ คุณจะรู้สึกว่าตัวเองได้อยู่ในแวดวงของธรรมชาติ ด้วยการตกแต่งภายในที่มีความเป็นเอกลักษณ์และทันสมัย ห้องพักสไตล์โมเดิร์นที่นี่มีพื้นที่กว้างขวางและเตียงนอนที่สะดวกสบาย เมื่อเปิดประตูไปยังระเบียง จะมีวิวทิวทัศน์ที่งดงามของชายหาดที่น่าตื่นเต้นอยู่ด้านหน้า และเสียงคลื่นที่กำลังปลายทางลงบนชายหาดเพื่อให้คุณได้รับการผ่อนคลายและพักผ่อนจากความเครียดในชีวิตประจำวัน</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-rtype="Beach Front" data-toggle="modal" data-target=".book-now-modal-lg">
                                    Book
                                </button>
                                <?php } else { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-toggle="modal" data-target=".sign-in-to-book-modal">
                                ...
                                <?php } ?>
                                <small class="text-muted">฿5900 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow" style="height: 600px; width: 348px;">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Ocean View Room</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/ocean.gif" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                        <div class="card-body">
                            <p class="card-text">เมื่อเข้าไปในห้องพักที่ตั้งอยู่บนชั้นสูงสุดของโรงแรมนี้ ทันทีที่เปิดประตูเข้าไป คุณจะได้พบกับวิวทะเลที่ยิ่งใหญ่และสวยงามอย่างไม่น่าเชื่อ ทะเลสีครามเขียวเข้มและท้องฟ้าสีฟ้าสดใส ทำให้คุณรู้สึกกลับมาอยู่ในโลกของความเป็นไปได้ที่ไม่มีที่ไหนเทียบเท่า</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-rtype="Ocean View" data-toggle="modal" data-target=".book-now-modal-lg">
                                    Book
                                </button>
                                <?php } else { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-toggle="modal" data-target=".sign-in-to-book-modal">
                                ...
                                <?php } ?>
                                <small class="text-muted">฿5000 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow" style="height: 600px; width: 348px;">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Triple Room</h5>
                        </div>
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" src="image/triple.gif" data-holder-rendered="true" style="height: 225px; width: 100%; display: block;">
                        <div class="card-body"  >
                            <p class="card-text">เมื่อเข้าสู่ห้องพักทันทีที่เข้ามาจะพบกับห้องที่กว้างขวางและสะอาด โดยมีเตียงสามเตียงอยู่ตรงกลางห้อง และมีพื้นที่ว่างเพียงพอที่จะเดินเล่นและใช้งานได้สะดวกสบาย มีห้องน้ำอยู่ในห้องเดียวกันกับพื้นที่นอน มีการตกแต่งด้วยเครื่องใช้สุขภาพที่ครบครัน เช่น น้ำยาล้างมือ และผ้าเช็ดตัว มีทั้งแผ่นเสริมผม และที่จัดเก็บของสะดวกสบาย</p>
                            <div class="d-flex justify-content-between align-items-center" >
                                <?php if ($isSessionExists) { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-rtype="Triple" data-toggle="modal" data-target=".book-now-modal-lg">
                                    Book
                                </button>
                                <?php } else { ?>
                                <button type="button" class="btn btn-sm btn-outline-success" data-toggle="modal" data-target=".sign-in-to-book-modal">
                                ...
                                <?php } ?>
                                <small class="text-muted">฿4500 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <select required class="custom-select mr-sm-2"  name="roomType">
                                            ...
                                            <option value="<?php echo \models\RequirementEnum::OCEAN; ?>">Ocean View Room</option>
                                            <option value="<?php echo \models\RequirementEnum::BEACH; ?>">Beach Front Room</option>
                                            <option value="<?php echo \models\RequirementEnum::TRIPLE; ?>">Triple Room</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
